...
- [ ] Webhooks, importaciones, adjuntos y clientes HTTP: SSRF, validación, límites, reintentos, timeouts e idempotencia. Google Calendar ya no anuncia watch/webhook/pull ficticios; conserva únicamente el push saliente funcional. Google Drive fue eliminado por completo. Las rutas jerárquicas de adjuntos y webhooks ya exigen coincidencia entre URL y recurso persistido. Trello separa preview/apply explícitamente, mantiene paridad de resumen y conserva asociaciones card-label.
...
| 2026-08-14 | Fidelidad importación Trello | Rutas preview/apply explícitas; preview sin escrituras y con conteos reales; apply conserva `idLabels`; eliminada ruta booleana ambigua | Build 0/0; suite 859 pass, 0 fail, 1 skip | Incluido en este commit |
