...
- [ ] Revisar boundaries y vertical slices; dividir archivos monolíticos por caso de uso sin crear capas adicionales. El mirror de tarjetas ya tiene un único comando canónico compartido por REST/MCP; se eliminó el handler stub que no creaba la tarjeta destino. Card, Checklists y Workspaces ya eliminaron sus monolitos de 1.114, 647 y 593 líneas: se agrupan respectivamente por mutación/ciclo/relaciones, checklist/ítems y workspace/membresías/políticas. Conservan namespaces, contratos y discovery de Wolverine; continúan los monolitos restantes.
