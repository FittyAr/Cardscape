...
namespace RadzenBlazorApp1.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<RadzenBlazorApp1.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<RadzenBlazorApp1.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(RadzenBlazorApp1.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(RadzenBlazorApp1.Server.Models.ApplicationUser user)
        {
            try
            {
