...
namespace RadzenBlazorApp1.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<RadzenBlazorApp1.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(RadzenBlazorApp1.Server.Models.ApplicationRole role)
        {
            try
            {
