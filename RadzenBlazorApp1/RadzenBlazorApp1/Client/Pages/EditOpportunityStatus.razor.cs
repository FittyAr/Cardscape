...
namespace RadzenBlazorApp1.Client.Pages
{
    public partial class EditOpportunityStatus
    {
        ...
        {
            opportunity = await CrmDBService.GetOpportunityStatusById(id:Id);
        }
        
        protected bool errorVisible;
        protected OpportunityStatus opportunity;

        protected async Task FormSubmit()
        {
            try
            {
                await CrmDBService.UpdateOpportunityStatus(id:Id, opportunity);
