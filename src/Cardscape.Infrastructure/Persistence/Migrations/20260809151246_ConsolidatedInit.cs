...
{
    /// <inheritdoc />
    public partial class ConsolidatedInit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    WatchChannelId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    WatchResourceId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    WatchExpiresAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    SyncToken = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ThemeName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "default"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonymisedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    IsRestricted = table.Column<bool>(type: "INTEGER", nullable: false),
                    RestrictedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
