...
public static class McpToolScopePolicy
{
    ...
    private static FrozenDictionary<string, Scope> CreateCatalog()
    {
        ...
        [
            ...
            "imports_kanban_preview", "inbox_list", "inbox_unread_count", "integrations_email_list_addresses",
        ...
        [
            ...
            "custom_fields_set_value", "imports_kanban_apply", "inbox_mark_all_read", "inbox_mark_read",
